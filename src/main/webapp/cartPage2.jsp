						...
						<c:if test="${not empty sessionScope.cartItems}">
							<table>
								...
								<tbody>
									...
									//tVO.setTeaNum(1001);
									//TeaVO data = tDAO.selectOne(tVO);
									
									ArrayList<TeaVO> cart = tDAO.selectAll(null);
									...
									<c:forEach var="item" items="${sessionScope.cartItems}">
										<tr>
											<td class="shoping__cart__item"><img src="${item.imageUrl}"
												alt="${item.teaName}">
											...
											<td class="shoping__cart__total">${item.total}원</td>
