...
public class MemberDAO {
	...
	static final private String SQL_SELECTONE="SELECT MEMBER_ID, MEMBER_PW, MEMBER_NAME, MEMBER_ADDRESS, MEMBER_PHONE, MEMBER_EMAIL FROM MEMBER WHERE MEMBER_ID = ? AND MEMBER_PW = ?;";
	...
	static final private String SQL_UPDATE="UPDATE MEMBER SET MEMBER_PW = ?, MEMBER_NAME = ?, MEMBER_ADDRESS = ?, MEMBER_PHONE = ?, MEMBER_EMAIL = ? WHERE MEMBER_ID = ?;";
